...
if(isset($_POST['rmcdma']))  {

 $command = 'sudo  /usr/bin/spanbox.sh clear_cdma'; 
 exec($command);
}
...
function submitform() {
  document.forms["clearcdma"].submit();
}
</script>
...
<h3 style="margin-left:15px;">CDMA Link Reset</h3>
<div id="status_table">
<table width="700 px" style="margin-left:10 px; align:center;">
<tr>
<td  style="text-align:center;">
<form action="restartcdma.php" method="post" name="clearcdma" id="clearcdma">

<input type ="hidden" name="rmcdma" value="yes">
<input type ="button" value="Restart Link" name"rmcdma"
onClick="if(confirm('Do you want to restart the link? The network will be down for a few seconds!')) {
  submitform();
}
">
</form>
...
<br/><br/>
<a href="cdma.php"><img src="image/back.jpg" style="margin-left:75px;"></a>
