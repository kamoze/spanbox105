...
if(isset($_POST['restart'])){
        exec('sudo  /usr/bin/spanbox.sh wf_start'); 
}
if(isset($_POST['stop'])){
...
<h3 style="margin-left:15px;">WebFilter</h3>
<div id="status_table">
...
<tr>
  <td width="400 px" style="text-align:center;"><h4>START Filter</h4></td>
  <td  width ="150 px">
    <form method="POST">
...
<tr>
  <td width="400 px" style="text-align:center;"><h4>STOP Filter</h4></td>
  <td  width ="150 px">
    <form method="POST">
...
<tr>
  ...
  <td  width ="150 px">
   <a href="wf_config.php"><img src="image/configure.png" /></a>
  </td>
</tr>
</table>
