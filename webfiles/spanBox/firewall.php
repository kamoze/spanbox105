...
if(isset($_POST['restart'])){
        exec('sudo  /usr/bin/spanbox.sh fw_restart'); 
}
if(isset($_POST['stop'])){
 exec('sudo  /usr/bin/spanbox.sh fw_stop');
}
...
<h3 style="margin-left:15px;">FIREWALL</h3>
<div id="status_table">
...
<tr>
  <td width="400 px" style="text-align:center;"><h4>START FW</h4></td>
  <td  width ="150 px">
    <form method="POST">
...
<tr>
  <td width="400 px" style="text-align:center;"><h4>STOP FW</h4></td>
  <td  width ="150 px">
    <form method="POST">
...
<tr>
  ...
  <td  width ="150 px">
   <a href="firewall_config.php"><img src="image/configure.png" /></a>
  </td>
</tr>
</table>
