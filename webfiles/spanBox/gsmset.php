...
if(isset($_POST['gsmset']))  {

 $command = 'sudo  /usr/bin/spanbox.sh gsmset'; 
 exec($command);
}
...
<h3 style="margin-left:15px;">GSM SET FUNCTION</h3>
<div id="status_table">
<table width="700 px" style="margin-left:10 px; align:center;">
<tr>
<td  style="text-align:center;">
<form action="gsmset.php" method="post" name="gsmset" id="gsmset">

<input type ="hidden" name="gsmset" value="yes">
<input type ="button" value="SET GSM 3G" name"gsmset"
onClick="if(confirm('Do you want to set the device to GSM mode? You can only use GSM dongles!')) {
  submitform();
}
">
</form>
